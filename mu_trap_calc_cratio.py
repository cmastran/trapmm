...
min_rib_width = 0.6  # mm
max_rib_width = 4.0  # mm
...
#
matname = 'PDMS'
E = 2.82e3  #  PDMS Young modulus (Sylgard 184) mN/mm^2
Nu = 0.421  #  PDMS Poisson's ratio

matname2 = 'GLASS'
E2 = 50e6  #  glass Young modulus mN/mm^2
#E2 = 2.82e3  #  PDMS Young modulus (Sylgard 184) mN/mm^2
Nu2 = 0.18  #  glass Poisson's ratio

STL_tolerance = 1.0e-4  # stl distance tolerance for merging nodes
bound_tol = STL_tolerance
...
pol_base = polygon(points=[[-rib_length/2.0,min_rib_width/2.0],[rib_length/2.0,max_rib_width/2.0], 
                        [rib_length/2.0,-max_rib_width/2.0],[-rib_length/2.0,-min_rib_width/2.0]] , 
                        paths=[[0,1,2,3]])
                    
sq = square(10)
#pol_rib = linear_extrude(height=rib_thickness,center=True, convexity = 10, twist = 0) (pol_base)
...
#
make_stl_internal_tetra_faces(internal_face_file,number_of_ribs,rib_length,min_rib_width,max_rib_width,rib_radius,plate_thickness)
...
#  make here the openscad file with the solid

make_oscad_file(number_of_ribs,32,rib_radius,min_rib_width,max_rib_width,rib_thickness,rib_length,
                plate_thickness,plate_radius,oscad_file)
...
# merge the STL file with the internal faces

sys.stdout.write('adding internal faces ... ')
sys.stdout.flush()

Merge_And_Correct_STL_Files(stl_file,internal_face_file,stl_file,STL_tolerance)
print 'done\n'
...
filepoststrip = 'meshsolid.msh'
abaqusmeshfile = 'meshsolid_multi.inp'
...
sys.stdout.write('making multimaterial inp file ... ')
sys.stdout.flush()
make_multimaterial_inp_file('meshsolid.inp', 'meshsolid_multi.inp',plate_thickness,bound_tol)
print 'done\n'
...
assemble_multimaterial_input_deck(
    num_el,
    matname,
    E,
    Nu,
...
# this is the deflection ratio (coma/uni) for 1 mm plate, 15 mm radius
coma_uniratio_1mm = 0.0407477529214
